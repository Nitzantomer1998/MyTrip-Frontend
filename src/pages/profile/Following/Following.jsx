...
import {  getFollowingPageInfos, getFollowingPageInfosId } from "../../../functions/user"
...
export default function Following(props) {
    ...
    const fetchFollowing = async () => {
        ...
        console.log("AND THE PERSON IS:", location.state)
        let following = []
        if(location.state.user._id === user.id){
            ...
            following = (await getFollowingPageInfosId(location.state.user._id, user.token)).data.following;
            ///following = (await getFollowingPageInfos(user.token)).data.following;
