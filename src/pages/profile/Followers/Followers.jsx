...
import { getFollowersPageInfos,getFollowersPageInfosId, unfollow } from "../../../functions/user"
  ...
  const location = useLocation();
    ...
    const fetchFriends = async() => {
      ...
      if(location.state.user._id === user.id){
        ...
        followers = (await getFollowersPageInfosId(location.state.user._id, user.token)).data.followers;
